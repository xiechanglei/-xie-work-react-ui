...
const IconTreeMenuItem: FC<TreeMenuItemProps & {
    ...
    return <NavMenuItem onClick={e => e.stopPropagation()} className={"tree-menu-item"}>
        <NavMenuTitle onClick={toggleSubMenu} ref={itemRef}
                      className={(active ? "active " : "") + "tree-menu-item-title"}>
...
const TreeMenuItem: FC<TreeMenuItemProps> = (props) => {
    ...
    return <NavMenuItem onClick={e => e.stopPropagation()} className={"tree-menu-item"}>
        <NavMenuTitle onClick={toggleSubMenu} ref={itemRef}
                      className={(hide ? "" : "active-title ") + "tree-menu-item-title"}>
            {formatIcon(menuInfo.icon)}
 ...
 * @constructor
 */
const TreeMenuList: FC<TreeMenuListProps> = (props) => {
    ...
    return <TreeMenuListWrapper className={uiClassName("tree-menu-list " + composeClassName)}
                                style={style}>
